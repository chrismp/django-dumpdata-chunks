...
class Command(BaseCommand):
	...
	def handle(self, *app_labels, **options):
		...
		max_records_per_chunk = int(options.get('max_records_per_chunk'))
		format = options.get('format')
		indent = None if options.get('indent')==None else int(options.get('indent'))
